...
const DadosPessoas = () => {
    ...
    return (
        <form onSubmit={finalizarCadastro}>
            ...
            <Row>
                <Col lg={4} md={4} sm={4}>
                    <ListaSuspensa titulo="Estado" opcoes={estadosBrasileiros} valor={usuario.uf} onChange={setUf} />
                </Col>
                <Col lg={8} md={8} sm={8}>
            ...
            <Row>
                <Col>
                    <CampoTexto titulo="E-mail" valor={usuario.email} onChange={setEmail} />
                </Col>
            </Row>
            <Row>
                <Col lg={6} md={6} sm={6}>
